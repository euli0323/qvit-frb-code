...
from utilitys.loss_function import (
...
def build_model(config, device):
    model = ViT(
        ...
        dim_head_before_qkv_proj=config['dim_head_before_qkv_proj'],
        ...
        qkv_projection=config.get('qkv_projection', 'linear'),
        dim_head_after_qkv_proj=config.get('dim_head_after_qkv_proj'),
        qkv_mlp_hidden_dim=config.get('qkv_mlp_hidden_dim', 3),
